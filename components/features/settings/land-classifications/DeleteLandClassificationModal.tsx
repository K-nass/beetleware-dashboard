        ...
        <div className="p-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6 space-y-2">
            <div>
              ...
              <p className="text-gray-900 font-medium">{classification.code}</p>
            </div>
            <div>
              <span className="text-sm font-medium text-gray-500">Name (EN):</span>
              <p className="text-gray-900">{classification.nameEn}</p>
            </div>
            <div>
              <span className="text-sm font-medium text-gray-500">Name (AR):</span>
              <p className="text-gray-900" dir="rtl">{classification.nameAr}</p>
            </div>
            <div>
