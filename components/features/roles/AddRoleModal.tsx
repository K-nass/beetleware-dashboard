...
import { PageWithClaimsDto } from "@/types/role";
...
export default function AddRoleModal({ pagesWithClaims }: AddRoleModalProps) {
  const router = useRouter();
  const modalRef = useRef<HTMLDivElement>(null);

  const [state, action, isPending] = useActionState(addRole, null);
